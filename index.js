...
function preguntarNumero() {
    return new Promise((resolve) => {
        ...
        rl.question('📱 Ingresa tu número de WhatsApp (con código de país, sin + ni espacios, ej: 521234567890): ', (numero) => {
            rl.close();
            resolve(numero.trim());
        });
    });
...
async function iniciar() {
    ...
    const client = new Client({
        ...
        webVersionCache: {
            type: 'remote',
            remotePath: 'https://raw.githubusercontent.com/wppconnect-team/wa-version/main/html/2.3000.1023024765-alpha.html'
        },
        puppeteer: {
